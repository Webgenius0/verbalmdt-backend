                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('questions.update', $question->id) }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Enter question set title" value="{{ old('title', $question->title) }}" required>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div id="question-items">
                                @foreach(old('questions', $question->questions) as $q)
                                    <div class="question-item mb-2">
                                        <input type="text" name="questions[]" class="form-control mb-1" placeholder="Enter a question" value="{{ $q }}" required>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-success">Update Question Set</button>
