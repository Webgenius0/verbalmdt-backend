        ...
        <div class="col-md-10 py-5 mx-auto">
            <div class="card card-primary card-outline">
                <div class="card-header text-center">
                    {{ isset($timeline) ? 'Edit Timeline' : 'Add Timeline' }}
                </div>
                ...
                <div class="card-body">
                    ...
                    {{-- Form Start --}}
                    <form action="{{ isset($timeline) ? route('timelines.update', $timeline->id) : route('timelines.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div id="name-items">
                                @if(old('name'))
                                    @foreach(old('name') as $i => $nm)
                                        <div class="name-item border rounded p-3 mb-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <input type="text" name="name[]" class="form-control w-75" value="{{ $nm }}" placeholder="Enter Name" required>
                                            ...
                                            <div class="mt-2 desc-container">
                                                @foreach(old('description.' . $i, ['']) as $desc)
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-success">
                                {{ isset($timeline) ? 'Update Timeline' : 'Save Timeline' }}
                            </button>
